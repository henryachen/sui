...
impl AuthorityPerEpochStore {
    ...
    pub fn get_stored_execution_time_observations(
        ...
        let SuiSystemState::V2(system_state) = system_state else {
            fatal!("`PerObjectCongestionControlMode::ExecutionTimeEstimate` requires SuiSystemState V2");
        };
        ...
        // TODO-DNS verify that double-serialize and double-deserialize are necessary
