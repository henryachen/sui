...
// Check that we can get all coins of different types for a given address.
// Other features like pagination and limits are tested in other tests since they
// behave the same way as getCoins queries.
